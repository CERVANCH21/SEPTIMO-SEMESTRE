    ...
    for num_linea, linea in enumerate(lineas, start=1):
        ...
        for palabra in ["entier", "reel", "chaine"]:
            if palabra in linea:
                ...
                tabla_simbolos.insert("", tk.END, values=(palabra, ""))
        ...
        if match_declaracion:
            ...
            for nombre in nombres_variables:
                if nombre not in variables_declaradas:  # Evitar variables repetidas
        ...
        errores.append((num_linea, linea, "Error de sintaxis", f"ER{contador_errores}"))
        contador_errores += 1
